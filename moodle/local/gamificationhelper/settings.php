...
if ($hassiteconfig) {
    ...
    $ADMIN->add('local_gamificationhelper_category', new admin_externalpage('local_gamificationhelper_recommend', get_string('recommendations', 'local_gamificationhelper'), "$CFG->wwwroot/local/gamificationhelper/recommendPlugins.php"));
}
