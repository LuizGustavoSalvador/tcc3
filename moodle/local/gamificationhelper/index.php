...
echo html_writer::tag('li', '<i class="fa fa-question-circle" aria-hidden="true""></i> <b>' 
    . get_string('btnAbout', 'local_gamificationhelper') . '</b>: '
    . get_string('btnAboutDesc', 'local_gamificationhelper')
);

echo html_writer::tag('li', '<i class="fa fa-list-alt" aria-hidden="true""></i> <b>' 
    . get_string('btnPermissions', 'local_gamificationhelper') . '</b>: '
    . get_string('btnPermissionsDesc', 'local_gamificationhelper')
);

echo html_writer::tag('li', '<i class="fa fa-download" aria-hidden="true""></i> <b>' 
    . get_string('btnDownload', 'local_gamificationhelper') . '</b>: '
    . get_string('btnDownloadDesc', 'local_gamificationhelper')
);

echo html_writer::tag('li', '<i class="fas fa-book" aria-hidden="true"></i> <b>' 
    . get_string('btnConfig', 'local_gamificationhelper') . '</b>: '
    . get_string('btnConfigDesc', 'local_gamificationhelper')
);
...
echo html_writer::tag('li', '<b>' . get_string('blockGame', 'local_gamificationhelper') . '</b>: '
    . get_string('blockGameDesc', 'local_gamificationhelper')
);

echo html_writer::tag('li', '<b>' . get_string('levelUp', 'local_gamificationhelper') . '</b>: '
    . get_string('levelUpDesc', 'local_gamificationhelper')
);

echo html_writer::tag('li', '<b>' . get_string('formatTrail', 'local_gamificationhelper') . '</b>: '
    . get_string('formatTrailDesc', 'local_gamificationhelper')
);
