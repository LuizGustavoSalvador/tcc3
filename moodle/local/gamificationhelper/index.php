...
echo html_writer::tag('li', '<i class="fa fa-cog" aria-hidden="true"></i> <b>' . get_string('btnInstall', 'local_gamificationhelper') . '</b>: '. get_string('btnInstallDesc', 'local_gamificationhelper'));
