...
class fetchPermissions {
    ...
    public function getPermissionsHtml() {
        ...
        $html = '<div class="modal-header">
                ...
                <div class="modal-body">
                    <p>' . get_string('permissionsDescription', 'block_gamificationhelper') . '</p>
                    <ul>
                        <li class="allow-li"><i class="fa fa-check"></i> ' 
                            . get_string('permissionGranted', 'block_gamificationhelper') . 
                        '</li>
                        <li class="not-allow-li"><i class="fa fa-times"></i> ' 
                            . get_string('permissionDenied', 'block_gamificationhelper') . 
                        '</li>
                        <li class="not-allow-warning-li"><i class="fa fa-exclamation-triangle"></i> ' 
                            . get_string('permissionDeniedNotInstalled', 'block_gamificationhelper') . 
                        '</li>
                    </ul>
                    <h5 class="list-permissions">' 
                        . get_string('permissionsListTitle', 'block_gamificationhelper') . 
                    '</h5>';
    ...
    private function getPermissionsMap() {
        return [
            'blockGame' => [
                'moodle/site:manageblocks' => get_string('moodleSite:manageblocks', 'block_gamificationhelper') . 
                    ': moodle/site:manageblocks',
                'block/game:addinstance' => get_string('blockGame:addinstance', 'block_gamificationhelper') . 
                    ': block/game:addinstance'
            ],
            'blockXp' => [
                'moodle/site:manageblocks' => get_string('moodleSite:manageblocks', 'block_gamificationhelper') . 
                    ': moodle/site:manageblocks',
                'block/xp:addinstance' => get_string('blockXp:addinstance', 'block_gamificationhelper') . 
                    ': block/xp:addinstance',
                'block/xp:manage' => get_string('blockXp:manage', 'block_gamificationhelper') . ': block/xp:manage',
                'block/xp:viewlogs' => get_string('blockXp:viewlogs', 'block_gamificationhelper') . ': block/xp:viewlogs',
                'block/xp:viewreport' => get_string('blockXp:viewreport', 'block_gamificationhelper') . 
                    ': block/xp:viewreport'
            ],
            'trail' => [
                'format/trail:changeimagecontaineralignment' => get_string('formatTrail:changeimagecontaineralignment', 
                    'block_gamificationhelper') . ': format/trail:changeimagecontaineralignment',
                'format/trail:changeimagecontainernavigation' => get_string('formatTrail:changeimagecontainernavigation', 
                    'block_gamificationhelper') . ': format/trail:changeimagecontainernavigation',
                'format/trail:changeimagecontainersize' => get_string('formatTrail:changeimagecontainersize', 
                    'block_gamificationhelper') . ': format/trail:changeimagecontainersize',
                'format/trail:changeimageresizemethod' => get_string('formatTrail:changeimageresizemethod', 
                    'block_gamificationhelper') . ': format/trail:changeimageresizemethod',
                'format/trail:changeimagecontainerstyle' => get_string('formatTrail:changeimagecontainerstyle', 
                    'block_gamificationhelper') . ': format/trail:changeimagecontainerstyle',
                'format/trail:changesectiontitleoptions' => get_string('formatTrail:changesectiontitleoptions', 
                    'block_gamificationhelper') . ': format/trail:changesectiontitleoptions'
            ]
        ];
    }
